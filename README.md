...
This is a fork of https://github.com/catchpoint/workflow-telemetry-action
with fixes applied from the community forks:

- https://github.com/marocchino/workflow-telemetry-action/tree/update/node-version
- https://github.com/ycfreeman/workflow-telemetry-action/tree/master

This would not be possible without their OSS contributions, so
all credit for their work goes towards them.
  ...
  workflow-telemetry-action:
    ...
    steps:
      - name: Collect Workflow Telemetry
        uses: NathanP-7West/workflow-telemetry-action@v2
```
